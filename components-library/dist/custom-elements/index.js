...
const EmprenderClSelect$1 = class extends HTMLElement {
  ...
  render() {
    var _a;
    return (h(Host, null, this.label && h("label", { htmlFor: (_a = this.selectInputOptions) === null || _a === void 0 ? void 0 : _a.id }, this.label, this.requiredIndicator && h("span", { class: "req" }, "*")), h("select", { class: "form-control", ref: (el) => this.selectInput = el, onChange: () => this.onSelectChange() }, h("option", { value: "", selected: !this.value, disabled: true, hidden: true }, "Selecciona"), this.renderOptions(), this.renderSlot())));
  }
  get host() { return this; }
