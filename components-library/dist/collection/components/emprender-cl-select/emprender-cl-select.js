...
export class EmprenderClSelect {
  ...
  render() {
    ...
    return (h(Host, null,
      ...
      h("select", Object.assign({ class: this.checkData ? "form-control checkData_select" : 'form-control', ref: (el) => this.selectInput = el, onChange: () => this.onSelectChange() }, this.selectInputOptions),
