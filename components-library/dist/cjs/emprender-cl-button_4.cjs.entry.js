...
const EmprenderClButton = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, null, index.h("button", { class: `button ${(_a = this.modifiers) !== null && _a !== void 0 ? _a : ''}` }, this.text)));
  }
};
...
const EmprenderClIcon = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("span", { class: `icon-${this.icon}` })));
  }
...
const EmprenderClSelect = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, null, this.label && index.h("label", { htmlFor: (_a = this.selectInputOptions) === null || _a === void 0 ? void 0 : _a.id }, this.label, this.requiredIndicator && index.h("span", { class: "req" }, "*")), index.h("select", { class: "form-control", ref: (el) => this.selectInput = el, onChange: () => this.onSelectChange() }, index.h("option", { value: "", selected: !this.value, disabled: true, hidden: true }, "Selecciona"), this.renderOptions(), this.renderSlot())));
  }
  get host() { return index.getElement(this); }
};
