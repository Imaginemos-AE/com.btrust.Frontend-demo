...
const EmprenderClButton = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, null, index.h("button", { class: `button ${(_a = this.modifiers) !== null && _a !== void 0 ? _a : ''}`, style: this.buttonStyle }, this.text)));
  }
};
...
const EmprenderClIcon = class {
  ...
  renderPaths() {
    const paths = [];
    for (let index$1 = 0; index$1 < this.path; index$1++) {
      paths.push(index.h("span", { class: `path${index$1 + 1}` }));
    }
    return paths;
  }
  render() {
    return (index.h(index.Host, null, index.h("span", { class: `icon-${this.icon}` }, this.renderPaths())));
  }
...
const EmprenderClSelect = class {
  ...
  renderOptions() {
    var _a;
    return ((_a = this.options) !== null && _a !== void 0 ? _a : []).map(option => index.h("option", { value: option.id, selected: option.id === this.value }, option.name));
  }
  renderSlot() {
    var _a;
    if (!this.options) {
      return Array.from((_a = this.host.querySelectorAll('option')) !== null && _a !== void 0 ? _a : []).map(option => index.h("option", { value: option.value, selected: option.value === this.value }, option.text));
    }
  }
  render() {
    var _a;
    return (index.h(index.Host, null, this.label && index.h("label", { class: this.checkData ? "checkData_label" : '', htmlFor: (_a = this.selectInputOptions) === null || _a === void 0 ? void 0 : _a.id }, this.label, this.requiredIndicator && index.h("span", { class: "req" }, "*")), index.h("select", Object.assign({ class: this.checkData ? "form-control checkData_select" : 'form-control', ref: (el) => this.selectInput = el, onChange: () => this.onSelectChange() }, this.selectInputOptions), index.h("option", { value: "", selected: !this.value, disabled: true, hidden: true }, "Selecciona"), this.renderOptions(), this.renderSlot())));
  }
  get host() { return index.getElement(this); }
};
EmprenderClSelect.style = emprenderClSelectCss;

exports.emprender_cl_button = EmprenderClButton;
exports.emprender_cl_icon = EmprenderClIcon;
exports.emprender_cl_input = EmprenderClInput;
exports.emprender_cl_select = EmprenderClSelect;
