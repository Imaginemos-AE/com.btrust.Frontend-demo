...
function checkData(model) {
  const campo = [personalInformation, personalInformation2, financialInformation, references, workingInformation].find(e => JSON.stringify(Object.keys(model)) === JSON.stringify(Object.keys(e)));
