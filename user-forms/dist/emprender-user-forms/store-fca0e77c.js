...
function getCompanyInformation(data) {
  ...
  return {
    ...
    place: data['place'],
    departmentOfResidence: data['departmentOfResidence'],
    cityOfResidence: data['cityOfResidence'],
    stratus: (_a = data['stratus']) !== null && _a !== void 0 ? _a : 0,
    dwellingType: data['dwellingType'],
    rent: (_b = parseFloat(data['rent'])) !== null && _b !== void 0 ? _b : 0,
    companyType: data['companyType'],
    nit: data['nit'],
    foundatingDate: data['foundatingDate'],
    ...
    otherDestiny: data['otherDestiny'],
  };
}
function getJsonModelData(stateData) {
  ...
  console.log(Object.assign(Object.assign({}, informacionPersonal), { infoEconomica }));
