...
const EmprenderUfWorkingInformation = class {
  ...
  async componentWillLoad() {
    ...
    await utils.loadScript('https://imaginemos-ae.github.io/com.btrust.Frontend-demo/components-library/dist/emprender-components-library/emprender-components-library.esm.js', 'emprender-components-library', 'module');
    this.userInformation = await getUserModelsInformation(this.documentId);
  }
  getResponse() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    if (this.userInformation) {
      return (index.h(index.Host, null, index.h("emprender-uf-personal-information-3", { model: (_a = this.userInformation) === null || _a === void 0 ? void 0 : _a.personalInformation, model2: (_b = this.userInformation) === null || _b === void 0 ? void 0 : _b.personalInformation2, model3: (_c = this.userInformation) === null || _c === void 0 ? void 0 : _c.bankInformation, adminZone: true }), ((_d = this.userInformation) === null || _d === void 0 ? void 0 : _d.flow) === 'employee' || (index.h("emprender-uf-company-profile", { model: (_e = this.userInformation) === null || _e === void 0 ? void 0 : _e.companyInformation, adminZone: true })), ((_f = this.userInformation) === null || _f === void 0 ? void 0 : _f.flow) === 'independent' ? (index.h("emprender-uf-financial-company", { adminZone: true, model: (_g = this.userInformation) === null || _g === void 0 ? void 0 : _g.financialCompanyInformation })) : (index.h("emprender-uf-financial-information", { adminZone: true, model: (_h = this.userInformation) === null || _h === void 0 ? void 0 : _h.financialInformation })), index.h("emprender-uf-references", { model: (_j = this.userInformation) === null || _j === void 0 ? void 0 : _j.references, flow: (_k = this.userInformation) === null || _k === void 0 ? void 0 : _k.flow, viewRegistration: false, adminZone: true })));
    }
    else {
      return null;
    }
...
exports.emprender_user_administrative = EmprenderUfWorkingInformation;
