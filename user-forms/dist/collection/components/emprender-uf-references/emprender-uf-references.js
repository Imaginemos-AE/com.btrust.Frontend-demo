            ...
            h("div", { class: "col" },
              ...
              h("div", { class: "boxForm form p5" },
                ...
                h("div", { class: "row" },
                  ...
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { dataType: "texto", checkData: this.requiredData.indexOf('familyContactRelationship') > -1, label: "Relaci\u00F3n / Parentezco", value: this.model.familyContactRelationship, onInputChange: ev => this._setModel('familyContactRelationship', ev.detail) }))))),
              ...
              h("div", { class: "boxForm form p5" },
                ...
                h("div", { class: "row" },
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { dataType: "celular", label: this.flow === 'independent' ? 'Teléfono contacto comercial' : 'Teléfono contacto personal', checkData: this.requiredData.indexOf('friendContactPhone') > -1, value: this.model.friendContactPhone, onInputChange: ev => this._setModel('friendContactPhone', ev.detail) }))),
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { dataType: "texto", label: this.flow === 'independent' ? 'Relación' : 'Relación / Parentezco', checkData: this.requiredData.indexOf('friendContactRelationship') > -1, value: this.model.friendContactRelationship, onInputChange: ev => this._setModel('friendContactRelationship', ev.detail) })))),
