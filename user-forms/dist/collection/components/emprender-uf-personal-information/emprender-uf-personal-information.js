                  ...
                  h("div", { class: "col-lg-6" },
                    h("fieldset", { class: "mb0" },
                      ...
                      h("div", { class: "row" },
                        h("div", { class: "col-6" },
                          h("fieldset", null,
                            h("emprender-cl-select", { checkData: this.requiredData.indexOf('departmentOfBirth') > -1, value: this.model.departmentOfBirth, options: this._getSelectDepartmentOptions(), onSelectChange: ev => this._selectDropdownOption('departmentOfBirth', ev.detail, 'cityOfBirth') }))),
                        h("div", { class: "col-6" },
                          h("fieldset", null,
                            h("emprender-cl-select", { value: this.model.cityOfBirth, checkData: this.requiredData.indexOf('cityOfBirth') > -1, options: this._getSelectCitiesOptions('departmentOfBirth'), onSelectChange: ev => this._setModel('cityOfBirth', ev.detail) })))))),
                  h("div", { class: "col-lg-3" },
                    h("fieldset", null,
                      h("emprender-cl-select", { checkData: this.requiredData.indexOf('gender') > -1, label: "G\u00E9nero", value: this.model.gender, onSelectChange: ev => this._setModel('gender', ev.detail) },
