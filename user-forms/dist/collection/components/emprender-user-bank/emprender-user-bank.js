...
export class EmprenderUfReferences {
  ...
  async componentWillLoad() {
    ...
    this.model = ((_a = state.currentUserInformation) !== null && _a !== void 0 ? _a : {})['bankInformation'];
    // loadDefaultData();
  }
      ...
      h("section", { class: "clientForms" },
        h("div", { class: "container" },
          h("div", { class: "row justify-content-center" },
            h("div", { class: "wallet" },
              h("div", { class: "bankAccountForm" },
                h("h6", null, "Completa la siguiente informaci\u00F3n:"),
                h("div", { class: "box boxForm form" },
                  h("fieldset", null,
                ...
                h("p", { class: "italic" }, "En esta opci\u00F3n el desembolso se demorar\u00E1 entre 8 a 12 horas dependiendo del encaje bancario"))))))));
  }
