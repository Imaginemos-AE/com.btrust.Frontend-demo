            ...
            h("div", { class: "col" },
              ...
              h("div", { class: "boxForm form p5" },
                h("div", { class: "row" },
                  ...
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('otherIncomes') > -1, label: "Otros ingresos mensuales", value: this.model.otherIncomes, maskOptions: FINANCIAL_OPTIONS, onInputChange: ev => this._calculateTotalIncomes('otherIncomes', ev.detail) }))),
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
              ...
              h("div", { class: "boxForm form p5" },
                h("div", { class: "row" },
                  ...
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { label: "Otros egresos mensuales", checkData: this.requiredData.indexOf('otherExpenses') > -1, value: this.model.otherExpenses, maskOptions: FINANCIAL_OPTIONS, onInputChange: ev => this._calculateTotalExpenses('otherExpenses', ev.detail) })))),
