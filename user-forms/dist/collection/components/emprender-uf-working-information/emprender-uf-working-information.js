              ...
              h("div", { class: "boxForm form p5" },
                h("div", { class: "row mb20" },
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('companyName') > -1, label: "Nombre de la empresa donde trabajas", value: this.model.companyName, onInputChange: ev => this._setModel('companyName', ev.detail) }))),
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('position') > -1, label: "Cargo en la empresa", value: this.model.position, onInputChange: ev => this._setModel('position', ev.detail) }))),
                  h("div", { class: "col-md-6" },
                  ...
                  h("div", { class: "col-md-4" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('companyPhone') > -1, label: "Tel\u00E9fono de la empresa", value: this.model.companyPhone, onInputChange: ev => this._setModel('companyPhone', ev.detail) }))),
                  h("div", { class: "col-md-2" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('companyPhoneExtension') > -1, label: "Extensi\u00F3n", value: this.model.companyPhoneExtension, onInputChange: ev => this._setModel('companyPhoneExtension', ev.detail) }))),
                  h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { checkData: this.requiredData.indexOf('otherPhone') > -1, label: "Otro", value: this.model.otherPhone, inputOptions: { placeholder: '¿Cúal?' }, onInputChange: ev => this._setModel('otherPhone', ev.detail) })))),
