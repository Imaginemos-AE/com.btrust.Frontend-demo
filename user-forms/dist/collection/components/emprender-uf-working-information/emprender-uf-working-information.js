              ...
              h("div", { class: "boxForm form p5" },
                h("div", { class: "row mb20" },
                  ...
                  this.model.creditDestination === 'otro' && (h("div", { class: "col-md-6" },
                    h("fieldset", null,
                      h("emprender-cl-input", { dataType: "alfanumericoOpcional", checkData: this.requiredData.indexOf('otherPhone') > -1, label: "Otro destino del pr\u00E9stamo", value: this.model.otherPhone, inputOptions: { placeholder: '¿Cúal?' }, onInputChange: ev => this._setModel('otherPhone', ev.detail) }))))),
