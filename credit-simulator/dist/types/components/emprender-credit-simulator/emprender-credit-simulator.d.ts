...
export declare class EmprenderCreditSimulator implements ComponentInterface {
  ...
  _creditTypeChange(creditTypeId: number, calcBoundaries?: boolean): void;
  _calculateBoundaries(creditTypeId: number, calcBoundaries: boolean): void;
  calculateFieldBoundaries(sliderConfig: SliderConfig, creditTypeId: number, calcBoundaries?: boolean): void;
