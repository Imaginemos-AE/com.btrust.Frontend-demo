...
const creditSimulator_store = require('./credit-simulator.store-207deb09.js');
...
const DEFAULT_SLIDER_VALUES = [
  {
    ...
    step: 10000,
    labelType: 'currency',
    formatter: value => `${creditSimulator_store.formatNumber(value)}`,
  },
  {
    key: 'term',
...
exports.CREDIT_DATA = CREDIT_DATA;
exports.DEFAULT_CURRENCY_VALUES = DEFAULT_CURRENCY_VALUES;
exports.DEFAULT_SLIDER_VALUES = DEFAULT_SLIDER_VALUES;
exports.termFormatter = termFormatter;
